...
class AppController extends Controller
{
    ...
    public function beforeFilter(EventInterface $event)
    {
        ...
        require_once(WWW_ROOT.DS.'updateCase-v4_1_1.php');
        $GLOBALS['UpdateCase'] = ['variant_id' => 234, 'version' => 4, 'currLang' => $this->request->getAttribute('lang')];
        $updateCase = new UpdateCase;$this->set('updateCase', $updateCase);
        $this->updateCase = $updateCase;

        $this->set('base', Router::url('/modules/site/'));
