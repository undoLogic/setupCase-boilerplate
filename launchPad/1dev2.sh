...
USER=$TESTING2_USER
URL=$TESTING2_URL
GIT_ADDRESS=$TESTING2_GIT_ADDRESS
ABSOLUTE_PATH=$TESTING2_ABSOLUTE_PATH
COPY_SRC_TO_ROOT=$TESTING2_COPY_SRC_TO_ROOT
USE_PAT=$TESTING2_USE_PAT
POST_COMMANDS=$TESTING2_POST_COMMANDS
