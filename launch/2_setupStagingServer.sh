...
echo $SSH_USER@$SSH_HOST "cd $STAGING_ABSOLUTE_PATH && rm -rf $GITHUB_CURRENT_BRANCH && git clone git@github.com:$GITHUB_USER_SLASH_PROJECT.git --branch $GITHUB_CURRENT_BRANCH --single-branch $STAGING_ABSOLUTE_PATH/$GITHUB_CURRENT_BRANCH" && echo ""
...
ssh $SSH_USER@$SSH_HOST "cd $STAGING_ABSOLUTE_PATH && rm -rf $GITHUB_CURRENT_BRANCH && git clone git@github.com:$GITHUB_USER_SLASH_PROJECT.git --branch $GITHUB_CURRENT_BRANCH --single-branch $STAGING_ABSOLUTE_PATH/$GITHUB_CURRENT_BRANCH" && echo ""
